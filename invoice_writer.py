...
class WorkeryInvoicePDFWriter:
    ...
    def render(self, packet):
        ...
        can.drawString(450, 349, str(self.data['total_labout']))
        can.drawString(450, 323, str(self.data['total_materials']))
        can.drawString(450, 303, str(self.data['waste_removal']))
        can.drawString(450, 278, str(self.data['sub_total']))
        can.drawString(450, 259, str(self.data['tax']))
        can.drawString(448, 229, str(self.data['total']))
        can.drawString(448, 157, str(self.data['grand_total']))
        can.drawString(410, 135, str(self.data['payment_amount']))
        ...
        can.drawString(280, 93, str(self.data['client_signature']))
        can.drawString(105, 67, str(self.data['associate_sign_date']))
        can.drawString(410, 67, str(self.data['associate_signature']))
